...
Se conservaron únicamente componentes del stack aprobado. Las dependencias directas están fijadas, el lockfile es obligatorio y las herramientas de desarrollo no se importan al runtime. Las imágenes locales tienen tags concretos; los despliegues productivos deberán usar digest durante Fase 2.

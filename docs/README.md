...
- [Estado y resultados de Fase 4](backlog/phase-4-status.md)
- [Módulo de equipos](modules/equipment.md)
- [Operación de equipos](runbooks/equipment.md)
- [Resultados QA de Fase 4](qa/phase-4/README.md)
...
- [Backlog de épicas y capacidades](backlog/epics.md)

## Decisiones técnicas

- [Índice de ADR](decisions/README.md)
- [Plataforma web, región y entornos](decisions/adr-015-platform.md)
- [Stack y política de versiones](decisions/adr-016-stack.md)
- [Identidad y sesiones](decisions/adr-017-identity.md)
...
- [Matriz base de autorización](product/authorization-matrix.md)
- [Catálogo de formatos Excel](product/excel-formats.md)
- [Catálogo de plantillas](product/template-catalog.md)

...
| ADR | Decisión | Estado |
|---|---|---|
| [ADR-015](adr-015-platform.md) | Vercel, Supabase y estrategia de entornos | Aceptada para implementación; presupuesto aprobado |
| [ADR-016](adr-016-stack.md) | Stack TypeScript y Vitest | Propuesta aceptada para implementación |
| [ADR-017](adr-017-identity.md) | Supabase Auth, BFF, TOTP y sesiones de contexto | En revisión de seguridad/operación |

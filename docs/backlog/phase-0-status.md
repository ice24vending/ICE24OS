...
| F0-04 | Plataforma y entornos | En revisión | Presupuesto y revisión de residencia de datos |
...
| F0-07 | Identidad | En revisión | PoC de Keycloak y responsables de recuperación |
...
Se puede iniciar el monorepo y una primera entrega web sin datos productivos con esta base: Google Cloud México, Cloud Run, Node.js 24 LTS, Next.js, NestJS, Cloud SQL PostgreSQL/PostGIS, Keycloak, Cloud Storage, Pub/Sub, Cloud Tasks, Vitest, Playwright y Terraform. La matriz de autorización es denegación por defecto y el MVP es una rebanada vertical de mantenimiento.
